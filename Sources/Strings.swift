...
let translations: [String: (String, String, String)] = [
        ...
        "noName":       ("unnamed device", "без имени", "без назви"),
    "notAPrinter":  ("That device is not a label printer",
                     "Это устройство — не принтер этикеток",
                     "Цей пристрій — не принтер етикеток"),
